  ...
  Widget build(BuildContext context) {
          ...
          child: ClipRRect(
            ...
            child: Swiper(
              ...
              itemBuilder: (_, index) {
                ...
                return Image.asset('images/lost_found.jpg');
              },
              loop: false,
              pagination:
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      UIHelper.horizontalSpaceSmall(),
                      Text(
                          '${isBreedEmpty ? 'Unspecified' : post.breed} Color'),
                    ],
                  ),
    ...
    return Scaffold(
        appBar: ReusableAppBar(
          title: AppBarTitle('${toBeginningOfSentenceCase(postType)} details'),
        ),
        body: ListView(
          children: <Widget>[
            _buildSwiper(),
